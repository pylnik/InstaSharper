...
{
    internal class Deleting : IDemoSample
    {
        /// <summary>
        ///     Config values
        /// </summary>
        ...
        public Deleting(IInstaApi instaApi)
        {
            _instaApi = instaApi;
        }
        ...
        public async Task DoShow()
        {
            ...
            var user = await _instaApi.GetUserAsync("running_consultant");
            if (user == null)
            {
            ...
            var removed = _instaApi.RemoveFollowerAsync(user.Value.Pk);
